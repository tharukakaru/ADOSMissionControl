...
export function AltitudeProfile({ waypoints, flightPlan, terrainHeights }: AltitudeProfileProps) {
  ...
  return (
    ...
    >
      ...
      {/* Current position indicator. Kept visually distinct (cyan) from the
          flight path's brand yellow above, so the moving playback marker
          doesn't blend into the path line it's crossing. */}
      <line
        x1={posX}
        y1={PAD_TOP}
        x2={posX}
