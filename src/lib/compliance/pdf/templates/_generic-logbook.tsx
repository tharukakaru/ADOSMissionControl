...
export function GenericLogbookTemplate({
  ...
  return (
    <Document
      ...
      author={operator.operatorName ?? operator.pilotFirstName ?? "ARCOS Mission Control"}
    >
      <Page size="A4" style={baseStyles.page}>
        ...
        <Text style={baseStyles.footer} fixed>
          Generated by ARCOS Mission Control · {generatedAt.toISOString()} · {retentionLabel(spec.retentionMonths)}
        </Text>
      </Page>
    </Document>
  );
